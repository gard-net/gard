...
gard implements [**Landspeed Protocol 1.1 (LSP/1.1)**](docs/LSP_PROTOCOL_v1.md) — a small, auditable TCP framing with JSON control and binary data channels, discovery over mDNS, and optional pairing / TLS.
